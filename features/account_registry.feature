Feature: Account registry
  ...
  Scenario: User is able to update name of already created account
    Given Account registry is empty
    And I create an account using name: "stary", last name: "imie", pesel: "01234567890"
    When I update "name" of account with pesel: "01234567890" to "nowe"
    Then Account with pesel "01234567890" has "name" equal to "nowe"
